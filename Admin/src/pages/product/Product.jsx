...
const handleDelete = (productId)=>{
  ...
  return (
     <Box sx={{width:"100%",marginTop:10}}>
            <button  style={{position:'fixed',right:10,height:40, outline:'none',padding:10,borderRadius:5, border:'none', top:70,backgroundColor:'gray',color:'white',fontWeight:'bold'}}>
                <Link to="/product/create">TẠO SẢN PHẨM</Link>
            </button>

<table id="customers">
    <span style={{padding:10,display:'block',width:200}}>Danh sách sản phẩm</span>
    {
         products.map(item=>{
            return (
                <tr>
